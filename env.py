# -*- coding: utf-8 -*-
"""
Created on Wed May 19 14:45:31 2021
...
#            self.prior1187 = np.array(self.prior1187)
        ...
        self.CO2 = np.arange(250,651,dtype=np.int)  ## true CO2 range
        ...
        self.observation_space = np.zeros(401,dtype=float)
...
#        star_line = time.time()
        ...
        distribution_new=np.zeros(401,dtype=float)
